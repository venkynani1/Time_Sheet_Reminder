...
async function sendNow(req, res) { try { const results = await timesheetService.sendReminders(); res.json({ message: 'Reminder run completed.', results }); } catch (error) { res.status(400).json({ error: error.message }); } }
